...
import { ClaudeToolCard, CodexToolCard, DroidToolCard, OpenClawToolCard, OpenCodeToolCard, DefaultToolCard, AntigravityToolCard } from "./components";
...
export default function CLIToolsPageClient({ machineId }) {
  ...
  const renderToolCard = (toolId, tool) => {
    ...
    switch (toolId) {
      ...
      case "opencode":
        return <OpenCodeToolCard key={toolId} {...commonProps} activeProviders={getActiveProviders()} hasActiveProviders={hasActiveProviders} cloudEnabled={cloudEnabled} />;
      case "antigravity":
